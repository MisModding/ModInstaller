...
local UNESCAPES = {
  ['0'] = string.char(0), z = string.char(0), N    = string.char(0x85),
  a = string.char(0x07),     b = string.char(0x08), t    = string.char(0x09),
  n = string.char(0x0a),     v = string.char(0x0b), f    = string.char(0x0c),
  r = string.char(0x0d),     e = string.char(0x1b), ['\\'] = '\\',
}
...
---@class MisModding.Common.TinyYaml
local YAML =  {
  version = 0.1,
  parse = parse,
}

RegisterModule('MisModding.Common.TinyYaml', YAML)
return YAML